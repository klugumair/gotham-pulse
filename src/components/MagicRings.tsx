...
export default function MagicRings({
  ...
  const propsRef = useRef<Required<Omit<MagicRingsProps, "blur" | "className">>>({
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({ vertexShader, fragmentShader, uniforms: uniforms as never, transparent: true });
    ...
    const animate = (t: number) => {
      ...
      (uniforms.uTime.value as number) = t * 0.001 * p.speed;
      ...
      (uniforms.uMouse.value as THREE.Vector2).set(smoothMouse[0], smoothMouse[1]);
